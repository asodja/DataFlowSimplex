...
#define Simplex_FMEM_DEPTH (12288)
#define Simplex_VECTOR_DEPTH (4)
 ...
 * \param [in] instream_x The stream should be of size ((param_m * param_n) * 4) bytes.
 * \param [out] outstream_y The stream should be of size ((param_m * param_n) * 4) bytes.
 */
void Simplex(
	uint32_t param_col,
	uint32_t param_m,
...
typedef struct { 
	...
	const float *instream_x; /**<  [in] The stream should be of size ((param_m * param_n) * 4) bytes. */
	float *outstream_y; /**<  [out] The stream should be of size ((param_m * param_n) * 4) bytes. */
} Simplex_actions_t;
